...
function (_Component) {
  ...
  function ContributeForm(props) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 19:
                ...
                _this.updateSelectedProject(contribution);
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this), "updateSelectedProject", function (contribution) {
      var id = _this.props.selectedProject.id;
      var updateProjectURL = "http://localhost:3000/projects/".concat(id);
      var progress = (_this.props.balance + contribution) / _this.props.selectedProject.goal * 100;
      var status = "deployed";
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                minimumContribution = e.target.minimumContribution.value - 1;
...
function ProjectCreationProgressComponent(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_1__["Step"].Group, {
    ...
    completed: props.selectedProject.status === "created" || props.selectedProject.status === "deployed" || props.selectedProject.status === "funded"
    ...
    active: props.selectedProject.status === "deployed" || props.selectedProject.status === "funded",
...
module.exports = __webpack_require__(/*! /Users/francisco/Desktop/Projects/etheraizer-frontend/pages/projects/createproject.js */"./pages/projects/createproject.js");
