...
function (_Component) {
  ...
  function myprofile(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "mySupport", function () {
      var myContracts = _this.props.supportContracts.filter(function (contract) {
        return contract.user_id === _this.props.userData.id;
      });

      myContracts.map(function (contract) {
        return _this.props.allProjects.filter(function (project) {
          return contract.project_id === project.user_id;
        });
      });
    });
...
//# sourceMappingURL=myprofile.js.aa227787e599b9ef2590.hot-update.js.map