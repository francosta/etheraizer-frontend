...
contract Fundraise {
    ...
    modifier restricted() {
        ...
        "Only the manager of the contract can run this action."
        _;
    }
    ...
    // Check new constructor syntax on https://medium.com/@piyopiyo/how-to-write-constructor-in-solidity-version-0-4-22-and-above-dcb8c042974f
    ...
    function contribute() public payable {
        ...
        "You have not met the minimum contribution to become a supporter of this project"
    ...
    function approveRequest(uint index) public {
        ...
        "You cannot approve this request as you are not a supporter of this project."
    ...
    function finalizeRequest(uint index) public restricted {
        ...
        "This request cannot be executed as not enough supporters of the project have approved it."
